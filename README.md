...
Hardware - Tested with laptop i7-9750h, 16Gbs of Ram, RTX 2060 mobile (lower power) with 6Gbs of VRAM. On the described hardware, a 5 minute real-time novel object recognition video will be processed in 15 seconds by NORMAN system, with the deeplabcut tracking step bringing total processing time to 2 minutes 30 seconds. I reccommend any directx12 capable GPU with >= 6Gbs of VRAM.
